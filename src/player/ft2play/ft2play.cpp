...
void Ft2Play::mix8bNoLoop(voice_t *v, uint32_t numSamples)
{
...
void Ft2Play::mix8bLoop(voice_t *v, uint32_t numSamples)
{
    const int8_t *CDA_LinearAdr;
    uint8_t mixInMono, CDA_SmpEndFlag;
    int32_t realPos, sample, *audioMixL, *audioMixR, CDA_BytesLeft;
...
void Ft2Play::mix8bBidiLoop(voice_t *v, uint32_t numSamples)
{
    const int8_t *CDA_LinearAdr;
    uint8_t mixInMono, CDA_SmpEndFlag;
    int32_t realPos, sample, *audioMixL, *audioMixR, CDA_BytesLeft;
...
void Ft2Play::mix8bNoLoopLerp(voice_t *v, uint32_t numSamples)
{
    const int8_t *CDA_LinearAdr;
    uint8_t mixInMono, CDA_SmpEndFlag;
...
void Ft2Play::mix8bLoopLerp(voice_t *v, uint32_t numSamples)
{
    const int8_t *CDA_LinearAdr;
    uint8_t mixInMono, CDA_SmpEndFlag;
    int32_t realPos, sample, sample2, *audioMixL, *audioMixR, CDA_BytesLeft;
...
void Ft2Play::mix8bBidiLoopLerp(voice_t *v, uint32_t numSamples)
{
    const int8_t *CDA_LinearAdr;
    uint8_t mixInMono, CDA_SmpEndFlag;
    int32_t realPos, sample, sample2, *audioMixL, *audioMixR, CDA_BytesLeft;
...
void Ft2Play::mix8bRampNoLoop(voice_t *v, uint32_t numSamples)
{
    const int8_t *CDA_LinearAdr;
    uint8_t mixInMono, CDA_SmpEndFlag;
...
void Ft2Play::mix8bRampLoop(voice_t *v, uint32_t numSamples)
{
    const int8_t *CDA_LinearAdr;
    uint8_t mixInMono, CDA_SmpEndFlag;
    int32_t realPos, sample, *audioMixL, *audioMixR, CDA_BytesLeft, CDA_LVolIP, CDA_RVolIP;
...
void Ft2Play::mix8bRampBidiLoop(voice_t *v, uint32_t numSamples)
{
    const int8_t *CDA_LinearAdr;
    uint8_t mixInMono, CDA_SmpEndFlag;
    int32_t realPos, sample, *audioMixL, *audioMixR, CDA_BytesLeft, CDA_LVolIP, CDA_RVolIP;
...
void Ft2Play::mix8bRampNoLoopLerp(voice_t *v, uint32_t numSamples)
{
    const int8_t *CDA_LinearAdr;
    uint8_t mixInMono, CDA_SmpEndFlag;
...
void Ft2Play::mix8bRampLoopLerp(voice_t *v, uint32_t numSamples)
{
    const int8_t *CDA_LinearAdr;
    uint8_t mixInMono, CDA_SmpEndFlag;
    int32_t realPos, sample, sample2, *audioMixL, *audioMixR, CDA_BytesLeft, CDA_LVolIP, CDA_RVolIP;
...
void Ft2Play::mix8bRampBidiLoopLerp(voice_t *v, uint32_t numSamples)
{
    const int8_t *CDA_LinearAdr;
    uint8_t mixInMono, CDA_SmpEndFlag;
    int32_t realPos, sample, sample2, *audioMixL, *audioMixR, CDA_BytesLeft, CDA_LVolIP, CDA_RVolIP;
...
void Ft2Play::mix16bNoLoop(voice_t *v, uint32_t numSamples)
{
    uint8_t mixInMono, CDA_SmpEndFlag;
...
void Ft2Play::mix16bLoop(voice_t *v, uint32_t numSamples)
{
    uint8_t mixInMono, CDA_SmpEndFlag;
    const int16_t *CDA_LinearAdr;
    int32_t realPos, sample, *audioMixL, *audioMixR, CDA_BytesLeft;
...
void Ft2Play::mix16bBidiLoop(voice_t *v, uint32_t numSamples)
{
    uint8_t mixInMono, CDA_SmpEndFlag;
    const int16_t *CDA_LinearAdr;
    int32_t realPos, sample, *audioMixL, *audioMixR, CDA_BytesLeft;
...
void Ft2Play::mix16bNoLoopLerp(voice_t *v, uint32_t numSamples)
{
    uint8_t mixInMono, CDA_SmpEndFlag;
    const int16_t *CDA_LinearAdr;
    int32_t realPos, sample, sample2, *audioMixL, *audioMixR, CDA_BytesLeft;
...
void Ft2Play::mix16bLoopLerp(voice_t *v, uint32_t numSamples)
{
    uint8_t mixInMono, CDA_SmpEndFlag;
    const int16_t *CDA_LinearAdr;
    int32_t realPos, sample, sample2, *audioMixL, *audioMixR, CDA_BytesLeft;
...
void Ft2Play::mix16bBidiLoopLerp(voice_t *v, uint32_t numSamples)
{
    uint8_t mixInMono, CDA_SmpEndFlag;
    const int16_t *CDA_LinearAdr;
    int32_t realPos, sample, sample2, *audioMixL, *audioMixR, CDA_BytesLeft;
...
void Ft2Play::mix16bRampNoLoop(voice_t *v, uint32_t numSamples)
{
    uint8_t mixInMono, CDA_SmpEndFlag;
    const int16_t *CDA_LinearAdr;
    int32_t realPos, sample, *audioMixL, *audioMixR, CDA_BytesLeft, CDA_LVolIP, CDA_RVolIP;
...
void Ft2Play::mix16bRampLoop(voice_t *v, uint32_t numSamples)
{
    uint8_t mixInMono, CDA_SmpEndFlag;
    const int16_t *CDA_LinearAdr;
    int32_t realPos, sample, *audioMixL, *audioMixR, CDA_BytesLeft, CDA_LVolIP, CDA_RVolIP;
...
void Ft2Play::mix16bRampBidiLoop(voice_t *v, uint32_t numSamples)
{
    uint8_t mixInMono, CDA_SmpEndFlag;
    const int16_t *CDA_LinearAdr;
    int32_t realPos, sample, *audioMixL, *audioMixR, CDA_BytesLeft, CDA_LVolIP, CDA_RVolIP;
...
void Ft2Play::mix16bRampNoLoopLerp(voice_t *v, uint32_t numSamples)
{
    uint8_t mixInMono, CDA_SmpEndFlag;
    const int16_t *CDA_LinearAdr;
    int32_t realPos,sample, sample2, *audioMixL, *audioMixR, CDA_BytesLeft, CDA_LVolIP, CDA_RVolIP;
...
void Ft2Play::mix16bRampLoopLerp(voice_t *v, uint32_t numSamples)
{
    uint8_t mixInMono, CDA_SmpEndFlag;
    const int16_t *CDA_LinearAdr;
    int32_t realPos, sample, sample2, *audioMixL, *audioMixR, CDA_BytesLeft, CDA_LVolIP, CDA_RVolIP;
...
void Ft2Play::mix16bRampBidiLoopLerp(voice_t *v, uint32_t numSamples)
{
    uint8_t mixInMono, CDA_SmpEndFlag;
    const int16_t *CDA_LinearAdr;
    int32_t realPos, sample, sample2, *audioMixL, *audioMixR, CDA_BytesLeft, CDA_LVolIP, CDA_RVolIP;
...
void Ft2Play::mixAudio(int16_t *stream, int32_t sampleBlockLength)
{
    int32_t i, out32;
    voice_t *v;
...
void Ft2Play::ft2play_FillAudioBuffer(int16_t *buffer, int32_t samples)
{
    int32_t a, b;
